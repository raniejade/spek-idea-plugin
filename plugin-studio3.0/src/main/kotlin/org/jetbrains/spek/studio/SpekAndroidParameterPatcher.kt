...
class SpekAndroidParameterPatcher: SpekJvmParameterPatcher {
    ...
    private fun addFoldersToClasspath(module: Module, testArtifact: JavaArtifact?, classPath: PathsList) {
